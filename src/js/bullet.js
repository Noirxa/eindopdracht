...
// //     this.scale = new Vector(0.05, 0.05); // scale down the bullet image

// //     this.speed = 400;
// //   }

// //   onPreUpdate(engine, delta) {
// //     this.pos = this.pos.add(new Vector(1, 0).scale(this.speed * delta / 1000));
...
//         // } dit is de code die de docent had gemaakt is en correct is voor de rode 
